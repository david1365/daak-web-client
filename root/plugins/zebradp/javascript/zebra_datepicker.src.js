    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var init = function(update) {
            ...
            var
                ...
                date = new plugin.settings.calendar(),
                ...
                if (regexp.length) {
                    ...
                    if ((segments = regexp.exec(str_date))) {
                        ...
                        if (valid) {
                            ...
                            var date = new plugin.settings.calendar(original_year, (original_month || 1) - 1, original_day || 1);
        ...
        var generate_daypicker = function() {
            ...
            for (i = 0; i < 42; i++) {
                ...
                if (i % 7 === 0 && plugin.settings.show_week_number)
                    ...
                    html += '<td class="dp_week_number">' + getWeekNumber(new plugin.settings.calendar(selected_year, selected_month, (i - days_from_previous_month + 1))) + '</td>';
                ...
                if (plugin.settings.select_other_months && (i < days_from_previous_month || day > days_in_month)) {
                    ...
                    // use the Date object to normalize the date
                    // for example, 2011 05 33 will be transformed to 2011 06 02
                    var real_date = new plugin.settings.calendar(selected_year, selected_month, day),
                    ...
                    if ($.inArray(year, rule[2]) > -1 || $.inArray('*', rule[2]) > -1)
                        ...
                        if ((typeof month != 'undefined' && $.inArray(month, rule[1]) > -1) || $.inArray('*', rule[1]) > -1)
                            ...
                            if ((typeof day != 'undefined' && $.inArray(day, rule[0]) > -1) || $.inArray('*', rule[0]) > -1) {
                                ...
                                // get the weekday
                                var weekday = new plugin.settings.calendar(year, month - 1, day).getDay();
        ...
        var select_date = function(year, month, day, view, cell) {
            ...
            var
                ...
                // construct a new plugin.settings.calendar object from the arguments
                default_date = new plugin.settings.calendar(year, month, day, 12, 0, 0),
