...
//-------------------------------------------
		$.createModal = function(/*parentModal*/){
			...
			$.elements[id].bind('shown.bs.modal', function () {
				var searchMenu = $(this).find('.search-menu:first');
        ...
        $.createSearchBody = function(body){
            var searchBody =  $('<div class="message-box search-menu"> '+
			...
			$('body').bind("click.serach-body", function(){
				var searchBody =  $('body').find('.search-menu');
...
*/
        ...
        $.createSearchButton = function(searchBody){
            var searchButton = $('<div  class="close search" data-toggle="tooltip" data-placement="bottom" title="جستجو"> ' +
